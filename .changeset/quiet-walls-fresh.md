...
An atmosphere client picker, and a wall that is actually fresh.

**Open posts in the client you use.** bsky.app, mu.social and blacksky.community share a URL structure, so the picker in the header rewrites the host and nothing else. Blog and Steam links are left exactly as they are, because they are not atproto posts. The choice persists.
