...
**Implements:** [`changes/2026-07-26-lay_a_bluesky_feed.md`](../../../changes/2026-07-26-lay_a_bluesky_feed.md) §Proposed changes → `07-web-client.md` → Responsibilities, → Shape, → The feed state machine; implementation note 11. Targets [`07-web-client.md`](../../../07-web-client.md) §Responsibilities and §The feed state machine.
**Depends on:** 03, 13, 14
