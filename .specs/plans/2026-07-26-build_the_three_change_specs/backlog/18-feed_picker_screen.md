...
- [ ] Wire back, Escape and the close control to close it; focus enters the input on open and returns to the trigger on close; the content behind is `inert`; results are a list so a screen reader is told how many there are.
